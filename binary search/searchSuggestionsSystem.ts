...
function lexographicalOrder(product:string,searchWord:string,k:number):number{
    for(let i=0;i<k;i++){
...
function lower_bound(products:string[],searchWord:string,k:number,isLower:boolean=true):number{
